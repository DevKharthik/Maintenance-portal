...
class ApiService {
  ...
  // Get Notifications (fixed endpoint)
  static Future<List<MaintenanceNotification>> getNotifications() async {
    try {
      print('Fetching notifications from fixed endpoint');
      final response = await http.get(
        Uri.parse('$baseUrl/maint/noti/0001'),
        headers: {'Content-Type': 'application/json'},
      );
